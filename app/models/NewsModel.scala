...
object NewsModel {
  ...
  object BlockSize extends Enumeration {
    ...
    val SIZE4  = BlockSizeValue("SIZE4", 4, "col-md-4 col-lg-4")
    val SIZE6  = BlockSizeValue("SIZE6", 6, "col-md-6 col-lg-6")
    val SIZE8  = BlockSizeValue("SIZE8", 8, "col-md-8 col-lg-8")
    val SIZE12 = BlockSizeValue("SIZE12", 12, "col-md-12 col-lg-12")
  ...
  object RowHeight extends Enumeration {
    ...
    val HEIGHT1 = RowHeightValue("HEIGHT1", 1, "height-1")
    val HEIGHT2 = RowHeightValue("HEIGHT2", 2, "height-2")
    val HEIGHT3 = RowHeightValue("HEIGHT3", 3, "height-3")
    val HEIGHT4 = RowHeightValue("HEIGHT4", 4, "height-4")
    sealed case class RowHeightValue(code: String, height: Int, cssClass: String) extends super.Val(code)
