...
object NewsModel {
  ...
  object RowHeight extends Enumeration {
    ...
    val HEIGHT1 = RowHeightValue("HEIGHT1", 1, "height1")
    val HEIGHT2 = RowHeightValue("HEIGHT2", 2, "height2")
    val HEIGHT3 = RowHeightValue("HEIGHT3", 3, "height3")
    val HEIGHT4 = RowHeightValue("HEIGHT4", 4, "height4")
