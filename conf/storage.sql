...
update translation set text=replace(text,'margin: 6pt 0cm;','');
...
update translation set text=replace(text,'letter-spacing:.8pt;','');
update translation set text=replace(text,'margin: 15pt 0cm;','');
